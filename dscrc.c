...
static unsigned int crc16_rem(unsigned char byte)
{
	unsigned int rem, prev;
	int i, j;
	unsigned char cal[3], cb;
...
static unsigned int crc32_rem(unsigned char byte)
{
	unsigned int rem, prev;
	int i, j;
	unsigned char cal[5], cb;
...
static void get_crc16_table(void)
{
	unsigned int index, rem;
...
static void get_crc32_table(void)
{
	unsigned int index, rem;
